...
BuildRequires:		gcc-c++
BuildRequires:		libzorpll-6_0-12-devel
...
Group:                  System/Daemons
Requires:               libzorpll-6_0-12-devel
...
%package -n libzorp-6_0-12
Summary:                The runtime library of Zorp
Group:                  System/Daemons

%description -n libzorp-6_0-12
Zorp is a new generation firewall. It is essentially a transparent proxy
firewall, with strict protocol analyzing proxies, a modular architecture,
and fine-grained control over the mediated traffic. Configuration decisions
...
%post -n libzorp-6_0-12
ldconfig

%postun -n libzorp-6_0-12
ldconfig
...
%changelog
* Thu May 10 2017 Balasys Development Team <devel@balasys.hu> - 6.0.12
