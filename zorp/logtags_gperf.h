...
enum
{
  ...
  LOGTAG_VNC_DEBUG=128,
  LOGTAG_VNC_ERROR=129,
  LOGTAG_VNC_INFO=130,
  LOGTAG_VNC_POLICY=131,
  LOGTAG_VNC_SESSION=132,
  LOGTAG_VNC_VIOLATION=133,
  LOGTAG_WHOIS_DEBUG=134,
  LOGTAG_WHOIS_ERROR=135,
  LOGTAG_WHOIS_REQUEST=136,
  LOGTAG_X11_DEBUG=137,
  LOGTAG_X11_ERROR=138,
  LOGTAG_X11_INFO=139,
  LOGTAG_X11_POLICY=140,
  LOGTAG_X11_SESSION=141,
  LOGTAG_X11_VIOLATION=142,
  LOGTAG_MAX=143
