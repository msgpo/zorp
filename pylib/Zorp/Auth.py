...
class AuthenticationPolicy(object):
    ...
    <class maturity="stable" type="authenticationpolicy">
      ...
      <description>
        <para>Authentication policies determine how the user is authenticated to access
        the service. The <parameter>authentication_policy</parameter> attribute
        of a service can reference an instance of the AuthenticationPolicy class.</para>
        <example>
        ...
        <synopsis>AuthenticationPolicy(name="demo_authentication_policy", cache=None, authentication=InbandAuthentication(), provider="demo_authentication_provider")</synopsis>
       <para>
        To use the authentication policy, include it in the definition of the service:</para>
        <synopsis>Service(name="office_http_inter", proxy_class=HttpProxy, authentication_policy="demo_authentication_policy", authorization_policy="demo_authorization_policy")</synopsis>
        </example>
        <example>
        ...
        <synopsis>AuthenticationPolicy(name="demo_authentication_policy", cache=AuthCache(timeout=600, update_stamp=TRUE, service_equiv=TRUE, cleanup_threshold=100), authentication=InbandAuthentication(), provider="demo_authentication_provider")</synopsis>
        </example>
      </description>
      <metainfo>
        <attributes>
